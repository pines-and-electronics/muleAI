...
CONTROLLER_NUM = '/dev/input/js1'
CONTROLLER_NUM = '/dev/input/js0'
...
class Joystick():
    ...
    def __init__(self, dev_fn=CONTROLLER_NUM):
        self.axis_states = {}
        self.button_states = {}
        self.axis_map = []
        self.button_map = []
    ...
    def poll(self):
        ...
        if evbuf:
            ...
            if typev & 0x80:
                ...
                #print('init',tval, value, typev, number, button, button_state, axis, axis_val)
                #print()
                return tval, value, typev, number, button, button_state, axis, axis_val
...
while True:
    ...
    #zip()
    #print("{} {} {} {} ".format(*res))
    #print("tval {:<10}, value {:<7}, typev {:<5}, number {:<4}, button {:<10}, button_state {:<5}, axis {:<5}, axis_val {:<5}".format(*res))

    print("tval {:10}, value {:7}, typev 0x{:5x}, number {:4}, button {}, button_state {}, axis {}, axis_val {}".format(*res))
#except:
    #pass
